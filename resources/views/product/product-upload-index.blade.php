...
--}}
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <h4 class="card-title">File Upload List</h4>
                                <hr>
                                            ...
                                            @if(isset($product_orders))
                                                ...
                                                @foreach($product_orders as $product_order)
                                                    <tr id="{{$product_order->product_order_id}}">
                                                        ...
                                                        <td>
                                                            {{$product_order->customer->mobile_number}}
                                                        </td>
                                                        ...
                                                        <td>
                                                            @if($product_order->file_upload_complete_yn == 'Y')
...
{{--
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="tentative_confirmation" class="required">Tentative Confirmation</label>
...
*/
            ...
            $(document).on("click", ".btnNotify", function () {
                ...
                alertify.confirm('Confirm Infrom', 'Are you sure?',
                    function () {

                        var product_order_id = $(that).closest('tr').attr('id');
                        console.log(product_order_id);

                        var url = '{{ route('product.file-upload-confirmation') }}';

                        var detail = {};
                        detail.product_order_id = product_order_id;
                        detail.file_upload_complete_yn = '{{\App\Enums\YesNoFlag::YES}}';
                        ...
                        $.ajax({
                            ...
                            success: function (resp) {
                                ...
                                if (resp.o_status_code == 1) {
                                     ...
                                     $(that).closest('tr').find('.notified').html('Yes');
                                    // $(that).closest('tr').find('.btnNotify').html('<span>Notify again<span>');
                                    alertify.success(resp.o_status_message);
                                } else {
                                    alertify.error(resp.o_status_message);
                                }
