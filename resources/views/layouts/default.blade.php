...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/bootstrap-datepicker/css/bootstrap-datepicker.standalone.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/jquery-validation/dist/style.css')}}">
...
<script>
    $(function () {
        var regExpressionBanglali = /^([\u0980-\u09FF]|[\u0020-\u002F]|[\u003A-\u0040]|[\u005B-\u0060]|[\u007B-\u007E])*$/;

        $(".bn-lang-val-check").on('input textchange paste', function (event) {
            if (!regExpressionBanglali.test($(this).val())) {
