    ...
    <section class="mt-4">
        <div class="row">
            <div class="col-12">
                ...
                <h3 class="text-center text-muted mb-2">Preview Your Terms & Conditions</h3>
                <div class="card mt-2">
                    <div class="card-body">
                        <h3 class="card-title">Terms & Conditions</h3>
                        <h5>Welcome to <span> CNS Limited </span></h5>
                        
                      
                      <p class="card-text">These terms and conditions outline the rules and regulations for the use of CNS Limited, located at Mirpur DOHS</p>
                      ...
                      <h4>You Must Know</h4>
                      <ul class="">
                        <li class="">Republish material from CNS ltd</li>
                        <li class="">Sell, rent or sub-license material from Website Name</li>
                        <li class="">Redistribute content from CNS ltd</li>
