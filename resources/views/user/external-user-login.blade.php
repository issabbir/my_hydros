		...
		<div class="col-xl-7 col-10">
			<div class="row m-0">
				...
				<div class="col-md-6 col-12 px-0 bg-rgba-cblack">
					<form class="" action="{{ route('external-user-login-check') }}" method="post">
						<div class="card-header pb-0">
							<div class="card-title">
								<img src="{{asset('/assets/images/logo/cpa-logo.png')}}" alt="users view avatar" class="img-fluid mx-auto d-block">
								<h4 class="text-center mt-1 text-white">External Login</h4>
								<h4 class="text-center mt-1 text-white">Please login for external user</h4>
							</div>
						</div>
						<div class="card-content">
							<div class="card-body">
								...
								<div class="form-group">
									...
									<input type="email" class="form-control" name="user_name" id="exampleInputPassword1"
							...
							<div class="card-body">
								...
								<div class="text-center row">
								 <div class="col-md-12">
									 ...
									 <a href="{{ route('forget-password') }}" class="text-white col-md-8
